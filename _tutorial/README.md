...
[guide]:     https://github.com/oskarsjoberg-sl/wire/blob/master/docs/guide.md
...
``` shell
go install github.com/oskarsjoberg-sl/wire/cmd/wire@latest
```
...
$GOPATH/src/github.com/oskarsjoberg-sl/wire/_tutorial/wire.go:24:1:
inject InitializeEvent: no provider found for github.com/oskarsjoberg-sl/wire/_tutorial.Greeter
(required by provider of github.com/oskarsjoberg-sl/wire/_tutorial.Event)
...
[advanced]:   https://github.com/oskarsjoberg-sl/wire/blob/master/docs/guide.md#advanced-features
[cleanup]:    https://github.com/oskarsjoberg-sl/wire/blob/master/docs/guide.md#cleanup-functions
[interfaces]: https://github.com/oskarsjoberg-sl/wire/blob/master/docs/guide.md#binding-interfaces
[sets]:       https://github.com/oskarsjoberg-sl/wire/blob/master/docs/guide.md#defining-providers
[values]:     https://github.com/oskarsjoberg-sl/wire/blob/master/docs/guide.md#binding-values
