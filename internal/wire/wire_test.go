...
func loadTestCase(root string, wireGoSrc []byte) (*testCase, error) {
	...
	goFiles := map[string][]byte{
		"github.com/oskarsjoberg-sl/wire/wire.go": wireGoSrc,
	}
...
func (test *testCase) materialize(gopath string) error {
	...
	// Add go.mod files to example.com and github.com/oskarsjoberg-sl/wire.
	const importPath = "example.com"
	const depPath = "github.com/oskarsjoberg-sl/wire"
